...
jQuery(document).ready(function() {
    ...
    jQuery('#sepa_due_date, #novalnet_cc_manual_check_limit, #novalnet_sepa_manual_check_limit, #novalnet_invoice_manual_check_limit, #novalnet_paypal_manual_check_limit, #novalnet_invoice_guarantee_min_amount, #novalnet_invoice_guarantee_max_amount, #novalnet_sepa_guarantee_min_amount, #novalnet_sepa_guarantee_max_amount, #tariff_period, #tariff_period2, #tariff_period2_amount, #novalnet_public_key').parent().on('change', function() {
