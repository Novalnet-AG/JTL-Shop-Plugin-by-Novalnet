...
HTML;
    ...
    if ($_SESSION['AktiveZahlungsart']) {
        ...
        if ($paymentModule && strpos($paymentModule, 'novalnetbarzahlen') !== false && !empty($_SESSION['novalnet_cashpayment_token'])) {

            $slipUrl = !empty($_SESSION['novalnet_cashpayment_mode']) ? 'https://cdn.barzahlen.de/js/v2/checkout-sandbox.js' : '
