...
class NovalnetIdeal extends PaymentMethod
{
     ...
     * @var string
     */
    public $paymentName = 'novalnet_ideal';

    /**
     * @var string
     */
    public $paymentKey = 49;
    ...
    public function __construct($moduleID)
    {
        ...
        $this->moduleID = 'kPlugin_' . $this->novalnetGateway->helper->oPlugin->kPlugin . '_novalnetideal';
    ...
    public function isValidIntern($args_arr = array())
    {
        ...
        $this->novalnetGateway->setupShopInformationText($this->moduleID, 'ideal');
    ...
    public function handleAdditional($aPost_arr)
    {
        ...
        $smarty->assign(array(
            ...
            'nnLang'      => nnGetLanguageText(array(
                                                    '__NN_testmode',
