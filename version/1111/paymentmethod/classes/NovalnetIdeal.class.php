 ...
 *
 * Script: NovalnetIdeal.class.php
 *
 */
 ...
 * Class NovalnetIdeal
 */
class NovalnetIdeal extends PaymentMethod
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    public $novalnetIdealUrl = 'https://payport.novalnet.de/online_transfer_payport';
    ...
    {
        $this->paymentName = 'novalnet_ideal';
    ...
    public function preparePaymentProcess($order)
    {
        ...
        $paymentRequestParameters['key'] = 49;
        $paymentRequestParameters['payment_type'] = 'IDEAL';
        ...
        $paymentRequestParameters['hash'] = $this->helper->generateHashValue($paymentRequestParameters, 49); // Encodes the basic payment parameters before sending to third party

        $smarty->assign( array(
            'paymentUrl'       => $this->novalnetIdealUrl,
    ...
    {
        return $this->novalnetGateway->verifyNotification($order, $this->paymentName, 49, $args); // Finalises the order based on response
    }
    ...
    public function handleNotification($order, $paymentHash, $args)
    {
        ...
        $this->novalnetGateway->handlePaymentCompletion($order, $this->generateHash($order), 49, $this->paymentName, $args); // Completes the order
    }
