			...
			{if $one_click_shopping}
				...
				<div id="nn_saved_details">
					...
					<table style="width:100%">
						<tr>
							<td valign="top">{$nn_lang.credit_card_type}</td>
							<td valign="top">
						...
						<tr>
							<td valign="top">{$nn_lang.credit_card_name}</td>
							<td valign="top">
						...
						<tr>
							<td valign="top">{$nn_lang.credit_card_number}</td>
							<td valign="top">
						...
						<tr>
							<td valign="top">{$nn_lang.credit_card_date}</td>
							<td valign="top">
