...
<div class="container form">
    <fieldset>
        ...
        <div id="sepa_javascript_enable" style="display:none;">
            <p class="box_error"><strong>{$nn_lang.javascript_error}</strong></p>
        </div>
        ...
        {if $one_click_shopping}
            ...
            <div id="nn_saved_details">
                <table style="width:100%">
                    <tr>
                        <td valign="top">{$nn_lang.sepa_holder_name}</td>
                        <td valign="top">
                    ...
                    <tr>
                        <td valign="top">{$nn_lang.sepa_account_number}</td>
                        <td valign="top">
					...
					{if $nn_saved_details.referenceOption3}
						<tr>
							<td valign="top">{$nn_lang.sepa_bank_code}</td>
							<td valign="top">
			...
			{else}
				<table style="width:100%">
					<tr>
						...
						<td valign="top"><input type="text" id="nn_sepaowner" autocomplete="off" value="{$sepa_holder}" onkeypress="return isAlphanumeric(event)" /> </td>
					</tr>
					...
					<tr>
						<td></td>
						<td valign="top"><input type="checkbox" id="nn_sepa_mandate_confirm" style="position:relative; left:0px; top:auto" /> {$nn_lang.sepa_mandate_text} </td>
					</tr>

				{if $pin_by_callback}
					<tr>
						<td valign="top"> {$nn_lang.callback_phone_number} <span style='color:red'>*</span>
						</td>
						<td valign="top">
				...
				{elseif $pin_by_sms}
					<tr>
						<td valign="top"> {$nn_lang.callback_sms} <span style='color:red'>*</span>
						</td>
						<td valign="top">
				...
				<input id="nn_remote_ip" name="nn_remote_ip" type="hidden" value="{$remote_ip}" />
