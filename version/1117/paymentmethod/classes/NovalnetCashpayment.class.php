...
class NovalnetCashpayment extends PaymentMethod
{
    ...
    {
        $date='';
        if (nnIsDigits($this->novalnetGateway->helper->getConfigurationParams('cashpayment_slip_expiry'))) {
            $day = $this->novalnetGateway->helper->getConfigurationParams('cashpayment_slip_expiry');
