  ...
  <fieldset>
    ...
    <table style="width:100%; border:2">
      <tr>
        ...
        <input type="hidden" id="original_sepa_customstyle_css" value="{$sepa_css}" />
        <input type="hidden" id="original_sepa_customstyle_cssval" value="{$sepa_css_val}" />
        ...
        <div> <iframe id="payment_form_novalnetSepa" name="payment_form_novalnetSepa" width="100%" height="450" src="{$path}" onload="doHideLoadingImageAndDisplayIframe(this)" frameBorder="0" scrolling="no"></iframe></div>
          {literal}
