...
class NovalnetPrepayment extends PaymentMethod
{
    ...
    public function handleAdditional($aPost_arr)
    {
        ...
        $smarty->assign( array(
            ...
            'paymentTestmode' => $this->helper->getConfigurationParams('testmode', $this->paymentName),
    ...
    public function preparePaymentProcess($order)
    {
        ...
        if ($_SESSION['Zahlungsart']->nWaehrendBestellung == 0) {
            ...
            $this->novalnetGateway->verifyNotification($order, $this->paymentName, 27);
    ...
    public function finalizeOrder($order, $hash, $args)
    {
        ...
        return $this->novalnetGateway->verifyNotification($order, $this->paymentName, 27); // Finalises the order based on response
    }
    ...
    public function handleNotification($order, $paymentHash, $args)
    {
        ...
        $this->novalnetGateway->handlePaymentCompletion($order, $this->generateHash($order), 27, $this->paymentName); // Completes the order
    }
