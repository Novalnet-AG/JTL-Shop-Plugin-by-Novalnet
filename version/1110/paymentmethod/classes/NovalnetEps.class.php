...
class NovalnetEps extends PaymentMethod
{
    ...
    public function preparePaymentProcess($order)
    {
        ...
        $paymentRequestParameters['key'] = 50;
    ...
    {
        return $this->novalnetGateway->verifyNotification($order, $this->paymentName, 50, $args); // Finalises the order based on response
    }
    ...
    public function handleNotification($order, $paymentHash, $args)
    {
        ...
        $this->novalnetGateway->handlePaymentCompletion($order, $this->generateHash($order), 50, $this->paymentName, $args); // Completes the order
    }
