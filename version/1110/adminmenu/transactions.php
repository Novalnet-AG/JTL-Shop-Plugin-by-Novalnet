...
$orderDetails = $DB->$shopQuery('SELECT ord.fGesamtsumme, ord.kKunde, ord.cKommentar, ord.dErstellt, nov.cKonfigurations, nov.cZahlungsmethode, nov.nBetrag, nov.nStatuswert FROM tbestellung ord JOIN xplugin_novalnetag_tnovalnet_status nov ON ord.cBestellNr = nov.cNnorderid WHERE cNnorderid = "' . $request['orderNo'] . '"', 1);
...
$smarty->assign( array(
    ...
    'amtUpdateValid'  => in_array($paymentConfiguration['key'], array( 27, 37 )),
