 ...
 *
 * Script: Novalnet.giropay.class.php
 *
 */  
...
class NovalnetGiropay extends PaymentMethod
{
    ...
    public function preparePaymentProcess( $order )
    {
		...
		$paymentRequestParameters['hash'] = $this->helper->generateHashValue( $paymentRequestParameters, 69 ); // Encodes the basic payment parameters before sending to third party
		   
		Shop::Smarty()->assign( array(
			'paymentUrl'       => 'https://payport.novalnet.de/giropay',
    ...
    {		
        ...
        $this->novalnetGateway->handleViaNotification( $order, $this->generateHash( $order ), 69, $args ); // Redirects to handle_notification URL
    }
