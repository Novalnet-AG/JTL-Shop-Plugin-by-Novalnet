 ...
 *
 * Script: Novalnet.ideal.class.php
 *
 */
...
class NovalnetIdeal extends PaymentMethod
{
    ...
    public function preparePaymentProcess( $order )
    {
		...
		Shop::Smarty()->assign( array(
			'paymentUrl'       => 'https://payport.novalnet.de/online_transfer_payport',
    ...
    {		
        ...
        $this->novalnetGateway->handleViaNotification( $order, $this->generateHash( $order ), 49, $args ); // Redirects to handle_notification URL
    }
