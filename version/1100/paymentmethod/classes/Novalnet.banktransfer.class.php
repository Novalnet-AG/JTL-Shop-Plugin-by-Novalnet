 ...
 *
 * Script: Novalnet.banktransfer.class.php
 *
 */
...
class NovalnetBanktransfer extends PaymentMethod
{
    ...
    {		
        ...
        $this->novalnetGateway->handleViaNotification( $order, $this->generateHash( $order ), 33, $args ); // Redirects to handle_notification URL
    }
