		...
		<table class="list table">
			...
			<tbody>
				...
				<tr class="tab_bg{$smarty.foreach.bestellungen.iteration%2}">
					...
					<td style="cursor:pointer;text-decoration:underline" onclick="adminOrderDisplay('{$bestellen}') ;">{$oBestellung->cBestellNr}</td>
...
{foreach name=bestellungen from=$oBestellung_arr item=oBestellung}
	<div id='admin_order_display_block' style='display:none;' class='overlay_window_block'>
	</div>
{/foreach}
