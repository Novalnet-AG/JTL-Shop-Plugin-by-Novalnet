...
<table>
    ...
    <tr>
        <td><h1>Novalnet-Zahlungsplugin V11.1.3</h1><span>Vielen Dank, dass Sie die neueste Version des Novalnet Zahlungs-Plugins installiert haben. Diese Version bringt einige gro&szlig;artige neue Funktionen und Erweiterungen. Hoffentlich macht es Ihnen Spa&szlig;, damit zu arbeiten!</span></td>
        <td></td>
    </tr>
    <tr>
