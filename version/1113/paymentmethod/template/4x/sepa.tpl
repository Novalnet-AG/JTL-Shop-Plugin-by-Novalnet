    ...
    <div id='nn_payment_sepa' style='display:block;'>
        ...
        {if !empty($one_click_shopping)}
            ...
            <div id="nn_saved_details">
                ...
                {if !empty($nn_saved_details.referenceOption3)}
                    <div class="row">
                        <div class="col-xs-12 col-md-6">
                            <div class="form-group float-label-control">
                            <label class="control-label">{$nnLang.sepa_bank_code}</label>
        ...
        <div id="nn_new_card_details">
            ...
            {else}
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group float-label-control required">
                        <label class="control-label" for="nn_sepa_country">{$nnLang.sepa_country_name}</label>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group float-label-control required">
                        <label class="control-label" for="nn_sepa_bank_code">{$nnLang.sepa_bank_code}</label>
